...
import br.com.pyetro.vendas.online.errorhandling.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> buildResponseEntity(ApiError apiError) {
		StatusError status = apiError.getStatus();
		return new ResponseEntity<>(apiError, HttpStatus.valueOf(status.getCodigo()));
	}
}